...
select x.jenispenjamin,x.namakelas,x.pengorder,x.catatanorder,x.tglinputx,x.jeniskelamin,x.objectunitasalfk,x.colorjenisoperasi,x.jenisoperasi,x.namapasien,x.noregistrasi,x.umur,x.nocm,x.norec,x.tglinput,x.tglrencana,
...
select mj3.jenispenjamin,mk.namakelas,mp3.namalengkap as pengorder,to2.catatanorder,mj2.jeniskelamin,to2.objectunitasalfk,case when to2.objectjenisoperasifk=1 then '#FFB2B2' when to2.objectjenisoperasifk=2 then '#FFE0B2'
