...
import {
    ...
    LAPORAN_RL_3_3_GET,LAPORAN_RL_3_4_GET,LAPORAN_RL_3_5_GET,
    LAPORAN_RL_3_6_GET,LAPORAN_RL_3_7_GET,LAPORAN_RL_3_8_GET,
    LAPORAN_RL_3_9_GET,LAPORAN_RL_3_14_GET,LAPORAN_RL_3_13_GET,
    LAPORAN_RL_3_15_GET,LAPORAN_RL_3_11_GET,LAPORAN_RL_3_10_GET,
    LAPORAN_RL_4_GET,LAPORAN_RL_4_B_GET,
...
import {
    ...
    getLaporanRl_3_5Success,getLaporanRl_3_5Error,
    ...
    getLaporanRl_3_13Success,getLaporanRl_3_13Error,
    ...
    getLaporanRl_4Success,getLaporanRl_4Error,
    getLaporanRl_4_BSuccess,getLaporanRl_4_BError,
...
function* ongetLaporanRl_3_5({payload: {queries}}) {
    try{
        const response = yield call(serviceRekammedis.getLaporanRl_3_5, queries);
        yield put(getLaporanRl_3_5Success(response.data));
    } catch (error) {
        yield put(getLaporanRl_3_5Error(error));
    }
}

export function* watchongetLaporanRl_3_5(){
    yield takeEvery(LAPORAN_RL_3_5_GET, ongetLaporanRl_3_5)
}
...
function* ongetLaporanRl_3_13({payload: {queries}}) {
    try{
        const response = yield call(serviceRekammedis.getLaporanRl_3_13, queries);
        yield put(getLaporanRl_3_13Success(response.data));
    } catch (error) {
        yield put(getLaporanRl_3_13Error(error));
    }
}

export function* watchongetLaporanRl_3_13(){
    yield takeEvery(LAPORAN_RL_3_13_GET, ongetLaporanRl_3_13)
}
...
function* ongetLaporanRl_4({payload: {queries}}) {
    try{
        const response = yield call(serviceRekammedis.getLaporanRl_4, queries);
        yield put(getLaporanRl_4Success(response.data));
    } catch (error) {
        yield put(getLaporanRl_4Error(error));
    }
}

export function* watchongetLaporanRl_4(){
    yield takeEvery(LAPORAN_RL_4_GET, ongetLaporanRl_4)
}

function* ongetLaporanRl_4_B({payload: {queries}}) {
    try{
        const response = yield call(serviceRekammedis.getLaporanRl_4_B, queries);
        yield put(getLaporanRl_4_BSuccess(response.data));
    } catch (error) {
        yield put(getLaporanRl_4_BError(error));
    }
}

export function* watchongetLaporanRl_4_B(){
    yield takeEvery(LAPORAN_RL_4_B_GET, ongetLaporanRl_4_B)
}
