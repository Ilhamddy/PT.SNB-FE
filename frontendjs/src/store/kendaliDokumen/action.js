import {
    ...
    LAPORAN_RL_3_5_GET,LAPORAN_RL_3_5_GET_SUCCESS,LAPORAN_RL_3_5_GET_ERROR,
    ...
    LAPORAN_RL_4_B_GET,LAPORAN_RL_4_B_GET_SUCCESS,LAPORAN_RL_4_B_GET_ERROR,
...
export const getLaporanRl_1_2 = (queries) => ({
    type: LAPORAN_RL_1_2_GET,
    payload: {
        queries,
    },
});

export const getLaporanRl_1_2Success = (data) => ({
    type: LAPORAN_RL_1_2_GET_SUCCESS,
    payload: data,
});
...
export const getLaporanRl_2 = (queries) => ({
    type: LAPORAN_RL_2_GET,
    payload: {
        queries,
    },
});

export const getLaporanRl_2Success = (data) => ({
    type: LAPORAN_RL_2_GET_SUCCESS,
    payload: data,
});

export const getLaporanRl_2Error = (error) => ({
    type: LAPORAN_RL_2_GET_ERROR,
    payload: error,
});
...
export const getLaporanRl_3_4 = (queries) => ({
    type: LAPORAN_RL_3_4_GET,
    payload: {
        queries,
    },
});

export const getLaporanRl_3_4Success = (data) => ({
    type: LAPORAN_RL_3_4_GET_SUCCESS,
    payload: data,
});

export const getLaporanRl_3_4Error = (error) => ({
    type: LAPORAN_RL_3_4_GET_ERROR,
    payload: error,
});

export const getLaporanRl_3_5 = (queries) => ({
    type: LAPORAN_RL_3_5_GET,
    payload: {
        queries,
    },
});

export const getLaporanRl_3_5Success = (data) => ({
    type: LAPORAN_RL_3_5_GET_SUCCESS,
    payload: data,
});

export const getLaporanRl_3_5Error = (error) => ({
    type: LAPORAN_RL_3_5_GET_ERROR,
    payload: error,
});
...
export const getLaporanRl_3_7 = (queries) => ({
    type: LAPORAN_RL_3_7_GET,
    payload: {
        queries,
    },
});

export const getLaporanRl_3_7Success = (data) => ({
    type: LAPORAN_RL_3_7_GET_SUCCESS,
    payload: data,
});

export const getLaporanRl_3_7Error = (error) => ({
    type: LAPORAN_RL_3_7_GET_ERROR,
    payload: error,
});

export const getLaporanRl_3_8 = (queries) => ({
    type: LAPORAN_RL_3_8_GET,
    payload: {
        queries,
    },
});

export const getLaporanRl_3_8Success = (data) => ({
    type: LAPORAN_RL_3_8_GET_SUCCESS,
    payload: data,
});

export const getLaporanRl_3_8Error = (error) => ({
    type: LAPORAN_RL_3_8_GET_ERROR,
    payload: error,
});

export const getLaporanRl_3_9 = (queries) => ({
    type: LAPORAN_RL_3_9_GET,
    payload: {
        queries,
    },
});

export const getLaporanRl_3_9Success = (data) => ({
    type: LAPORAN_RL_3_9_GET_SUCCESS,
    payload: data,
});

export const getLaporanRl_3_9Error = (error) => ({
    type: LAPORAN_RL_3_9_GET_ERROR,
    payload: error,
});

export const getLaporanRl_3_13 = (queries) => ({
    type: LAPORAN_RL_3_13_GET,
    payload: {
        queries,
    },
});

export const getLaporanRl_3_13Success = (data) => ({
    type: LAPORAN_RL_3_13_GET_SUCCESS,
    payload: data,
});

export const getLaporanRl_3_13Error = (error) => ({
    type: LAPORAN_RL_3_13_GET_ERROR,
    payload: error,
});
...
export const getLaporanRl_4_B = (queries) => ({
    type: LAPORAN_RL_4_B_GET,
    payload: {
        queries,
    },
});

export const getLaporanRl_4_BSuccess = (data) => ({
    type: LAPORAN_RL_4_B_GET_SUCCESS,
    payload: data,
});

export const getLaporanRl_4_BError = (error) => ({
    type: LAPORAN_RL_4_B_GET_ERROR,
    payload: error,
});
