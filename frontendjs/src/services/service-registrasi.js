...
export default class ServiceRegistrasi {
    ...
    getWidgetDaftarPasienRJ = async (param) => {
        return await api.get(`/transaksi/registrasi/widget-daftar-pasien-registrasi-rj?&noregistrasi=${param}`);
    }
    ...
    getListPasienMutasi = async (param) => {
        return await api.get(`/transaksi/registrasi/get-list-pasien-mutasi?&search=${param}`);
    }
}