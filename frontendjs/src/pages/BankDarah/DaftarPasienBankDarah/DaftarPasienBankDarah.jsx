...
const DaftarPasienBankDarah = () => {
  ...
  useEffect(() => {
    dispatch(getDaftarPasienBankDarah({ search: search, dateStart: dateStart, dateEnd: dateEnd }))
  ...
  const handleClickCari = () => {
    dispatch(
      getDaftarPasienBankDarah({ search: search, dateStart: dateStart, dateEnd: dateEnd })
    )
  }
