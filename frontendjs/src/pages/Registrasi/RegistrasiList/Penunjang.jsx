...
const ModalPenunjang = ({
  ...
  const { editData, newData, loading, error, success } = useSelector(
    (state) => ({
                ...
                <Row>
                  ...
                  <Col md={8} className="mb-2">
                    <CustomSelect
                      ...
                      onChange={(value) =>
                        validation.setFieldValue('unittujuan', value?.value)
                      }
                      invalid={
                  ...
                  <Col md={4} className="mb-2">
                    <Label htmlFor="doktertujuan" className="form-label">
                      Dokter Tujuan
                    </Label>
                  </Col>
                  <Col md={8} className="mb-2">
                    <CustomSelect
                      ...
                      className={`input ${
                        validation.errors.doktertujuan ? 'is-invalid' : ''
                      }`}
                      onChange={(value) =>
                        validation.setFieldValue('doktertujuan', value?.value)
                      }
                      invalid={
                        validation.touched.doktertujuan &&
                        validation.errors.doktertujuan
                          ? true
                          : false
                      }
                    />
                    ...
                    validation.errors.doktertujuan ? (
                      <FormFeedback type="invalid">
                        <div>{validation.errors.doktertujuan}</div>
                      </FormFeedback>
                    ) : null}
                  </Col>
