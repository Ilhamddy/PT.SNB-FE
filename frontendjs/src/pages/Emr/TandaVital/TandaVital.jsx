...
const TandaVital = forwardRef(({ isHistory = true, vOutside }, ref) => {
    ...
    },
    {
      ...
      selector: (data) => {
        return (
          <button
            type="button"
            className={'btn btn-sm ' + data.status_sistole}
            onClick={() => handleClickSistole(data)}
          >
            {data.sistole}
          </button>
        )
    ...
    },
    {
      ...
      selector: (data) => {
        return (
          <button
            type="button"
            className={'btn btn-sm ' + data.status_diastole}
            onClick={() => handleClickDiastole(data)}
          >
            {data.diastole}
          </button>
        )
    ...
    },
    {
      ...
      selector: (data) => {
        return (
          <button
            type="button"
            className={'btn btn-sm ' + data.status_pernafasan}
            onClick={() => handleClickPernapasan(data)}
          >
            {data.pernapasan}
          </button>
        )
    ...
    },
    {
      ...
      selector: (data) => {
        return (
          <button
            type="button"
            className={'btn btn-sm ' + data.status_suhu}
            onClick={() => handleClickSuhu(data)}
          >
            {data.suhu}
          </button>
        )
    ...
    },
    {
      ...
      selector: (data) => {
        return (
          <button
            type="button"
            className={'btn btn-sm ' + data.status_nadi}
            onClick={() => handleClickNadi(data)}
          >
            {data.nadi}
          </button>
        )
    ...
    },
    {
      ...
      selector: (data) => {
        return (
          <button
            type="button"
            className={'btn btn-sm ' + data.status_kesadaran}
            onClick={() => handleClickKesadaran(data)}
          >
            {data.namagcs}
          </button>
        )
  ...
  }, [validation.values.gcse, validation.values.gcsm, validation.values.gcsv])
              ...
              <Row>
                ...
                <Col lg={6} sm={6} className="mt-1">
                  <div>
                    <CustomInput
                      ...
                      invalid={
                        validation.touched.tinggibadan &&
                        validation.errors.tinggibadan
                          ? true
                          : false
                      }
                    />
                    ...
                    validation.errors.tinggibadan ? (
                      <FormFeedback type="invalid">
                        <div>{validation.errors.tinggibadan}</div>
                      </FormFeedback>
                    ) : null}
                  </div>
                </Col>
                ...
                <Col lg={6} sm={6} className="mt-1">
                  <div>
                    ...
                    {validation.touched.suhu && validation.errors.suhu ? (
                      <FormFeedback type="invalid">
                        <div>{validation.errors.suhu}</div>
                      </FormFeedback>
                    ) : null}
                  </div>
                </Col>
                  ...
                  <Row>
                    <Col lg={4} md={6} sm={12}>
                      <div>
                        ...
                        {validation.touched.gcse && validation.errors.gcse ? (
                          <FormFeedback type="invalid">
                            <div>{validation.errors.gcse}</div>
                          </FormFeedback>
                        ) : null}
                      </div>
                    </Col>
                    <Col lg={4} md={6} sm={12}>
                      <div>
                        ...
                        {validation.touched.gcsm && validation.errors.gcsm ? (
                          <FormFeedback type="invalid">
                            <div>{validation.errors.gcsm}</div>
                          </FormFeedback>
                        ) : null}
                      </div>
                    </Col>
                    <Col lg={4} md={6} sm={12}>
                      <div>
                        ...
                        {validation.touched.gcsv && validation.errors.gcsv ? (
                          <FormFeedback type="invalid">
                            <div>{validation.errors.gcsv}</div>
                          </FormFeedback>
                        ) : null}
                      </div>
                    </Col>
              ...
              <Row>
                ...
                <Col lg={6} sm={6} className="mt-1">
                  <div>
                    <CustomInput
                      ...
                      invalid={
                        validation.touched.beratbadan &&
                        validation.errors.beratbadan
                          ? true
                          : false
                      }
                    />
                    ...
                    validation.errors.beratbadan ? (
                      <FormFeedback type="invalid">
                        <div>{validation.errors.beratbadan}</div>
                      </FormFeedback>
                    ) : null}
                  </div>
                </Col>
                ...
                <Col lg={6} sm={6} className="mt-1">
                  <div>
                    ...
                    {validation.touched.nadi && validation.errors.nadi ? (
                      <FormFeedback type="invalid">
                        <div>{validation.errors.nadi}</div>
                      </FormFeedback>
                    ) : null}
                  </div>
                </Col>
              ...
              <Row>
                ...
                <Col lg={3} sm={3} className="mt-1">
                  <div>
                    ...
                    {validation.touched.sistole && validation.errors.sistole ? (
                      <FormFeedback type="invalid">
                        <div>{validation.errors.sistole}</div>
                      </FormFeedback>
                    ) : null}
                  </div>
                </Col>
                ...
                <Col lg={3} sm={3} className="mt-1">
                  <div>
                    <CustomInput
                      ...
                      invalid={
                        validation.touched.diastole &&
                        validation.errors.diastole
                          ? true
                          : false
                      }
                    />
                    ...
                    validation.errors.diastole ? (
                      <FormFeedback type="invalid">
                        <div>{validation.errors.diastole}</div>
                      </FormFeedback>
                    ) : null}
                  </div>
                </Col>
                ...
                <Col lg={6} sm={6} className="mt-1">
                  <div>
                    ...
                    {validation.touched.spo2 && validation.errors.spo2 ? (
                      <FormFeedback type="invalid">
                        <div>{validation.errors.spo2}</div>
                      </FormFeedback>
                    ) : null}
                  </div>
                </Col>
                ...
                <Col lg={6} sm={6} className="mt-1">
                  <div>
                    <CustomInput
                      ...
                      invalid={
                        validation.touched.pernapasan &&
                        validation.errors.pernapasan
                          ? true
                          : false
                      }
                    />
                    ...
                    validation.errors.pernapasan ? (
                      <FormFeedback type="invalid">
                        <div>{validation.errors.pernapasan}</div>
                      </FormFeedback>
                    ) : null}
                  </div>
                </Col>
                ...
                <Col lg={6} sm={6}>
                  <div>
                    <CustomInput
                      ...
                      invalid={
                        validation.touched.keadaanumum &&
                        validation.errors.keadaanumum
                          ? true
                          : false
                      }
                    />
                    ...
                    validation.errors.keadaanumum ? (
                      <FormFeedback type="invalid">
                        <div>{validation.errors.keadaanumum}</div>
                      </FormFeedback>
                    ) : null}
                  </div>
                </Col>
                    ...
                    <div className="d-flex flex-wrap my-n1">
                      ...
                      <div className="d-flex align-items-center ms-4">
                        ...
                        <div className="flex-grow-1 ms-3">
                          <h6 className="fs-15 mb-0 fw-semibold">
                            <span className="fw-normal">
                              Belum Terupdate Ke Satu Sehat, Silahkan Klik
                              Content Yang Belum Terkirim
                            </span>
                          </h6>
                        </div>
                      </div>
