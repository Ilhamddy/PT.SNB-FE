...
const BiodataPegawai = () => {
  ...
  const vSetValidationPendidikanPegawai = useFormik({
    enableReinitialize: true,
    initialValues: {
      task: 5,
      idPegawai: '',
  ...
  const vTempColumn = useFormik({
    ...
    validationSchema: Yup.object({
      // kode: Yup.string().required('Kode belum diisi.')
    }),
    onSubmit: (values) => {
  ...
  const resepNonRacikan = tempColumtr?.resep.filter(
                              ...
                              <Row className="gy-2">
                                ...
                                <Col lg={8}>
                                  <CustomInput
                                    ...
                                    type="text"
                                    value={
                                      vSetValidationBiodata.values.inisialNama
                                    }
                                    onChange={(e) => {
                                      vSetValidationBiodata.setFieldValue(
                                        'inisialNama',
                                ...
                                <Col lg={4}>
                                  <CustomInput
                                    ...
                                    type="text"
                                    value={
                                      vSetValidationBiodata.values.tempatLahir
                                    }
                                    onChange={(e) => {
                                      vSetValidationBiodata.setFieldValue(
                                        'tempatLahir',
                                ...
                                <Col lg={4}>
                                  <KontainerFlatpickr
                                    ...
                                    value={
                                      vSetValidationBiodata.values.tglLahir ||
                                      dateNow
                                    }
                                    onChange={([newDate]) => {
                                      vSetValidationBiodata.setFieldValue(
                              ...
                              <Row className="gy-2">
                                ...
                                <Col lg={8}>
                                  <CustomInput
                                    ...
                                    type="textarea"
                                    value={
                                      vSetValidationAlamat.values.alamatDomisili
                                    }
                                    onChange={(e) => {
                                      vSetValidationAlamat.setFieldValue(
                                        'alamatDomisili',
                    ...
                    <Card>
                      <CardBody>
                        <Form
                          onSubmit={(e) => {
                            e.preventDefault()
                            vSetValidationPendidikanPegawai.handleSubmit()
                            return false
                          }}
                          className="gy-4"
                          action="#"
