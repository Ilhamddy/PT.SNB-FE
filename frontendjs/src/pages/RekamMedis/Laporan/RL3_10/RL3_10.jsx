...
import {
  getLaporanRl_3_10, kendaliDokumenResetForm
} from '../../../../store/actions';

const RL3_10 = () => {
  document.title = "Laporan RL3.10";
  const dispatch = useDispatch();
  const { dataGrid, loadingGrid } = useSelector((state) => ({
    dataGrid: state.KendaliDokumen.getLaporanRl_3_10.data,
    loadingGrid: state.KendaliDokumen.getLaporanRl_3_10.loading,
  }));
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Laporan RL3.10" pageTitle="Forms" />
          <Form
            onSubmit={(e) => {
              e.preventDefault();
