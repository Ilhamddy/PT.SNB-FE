...
import {
    laporanRL_3_1_Get,kendaliDokumenResetForm
} from '../../../../store/actions';
import "./RL3_1.scss"
...
const RL3_1 = () => {
    ...
    const handleExport = () => {
        ...
        XLSX.writeFile(workbook, 'laporan_rl3_1.xlsx');
    };
    ...
    return (
        <React.Fragment>
            ...
            <UiContent />
            <div className="page-content laporan-rl3-1">
                <Container fluid>
                    <BreadCrumb title="Laporan RL3.1" pageTitle="Forms" />
                    <Card>
                        <CardBody>
