...
import {
  getLaporanRl_3_8, kendaliDokumenResetForm
} from '../../../../store/actions';
import { Grid, _ } from 'gridjs-react';
import * as XLSX from 'xlsx';

const RL3_8 = () => {
  document.title = "Laporan RL3.8";
  const dispatch = useDispatch();
  const { dataGrid, loadingGrid } = useSelector((state) => ({
    dataGrid: state.KendaliDokumen.getLaporanRl_3_8.data || [],
    loadingGrid: state.KendaliDokumen.getLaporanRl_3_8.loading,
  }));
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Laporan RL3.8" pageTitle="Forms" />
          <Form
            onSubmit={(e) => {
              e.preventDefault();
