...
const DetailOrderModalPatologi = ({
  show,
  onSimpanClick,
  onCloseClick,
  onTolakClick,
                    ...
                    <Row>
                      ...
                      <Col md={8} className="mb-2">
                        <CustomSelect
                          ...
                          className={`input ${
                            validation.errors.nokamar ? 'is-invalid' : ''
                          }`}
                          onChange={(value) =>
                            validation.setFieldValue('nokamar', value?.value)
                          }
                          invalid={
                            validation.touched.nokamar &&
                            validation.errors.nokamar
                              ? true
                              : false
                          }
                        />
                        ...
                        validation.errors.nokamar ? (
                          <FormFeedback type="invalid">
                            <div>{validation.errors.nokamar}</div>
                          </FormFeedback>
                        ) : null}
                      </Col>
                    </Row>
...
DetailOrderModalPatologi.propTypes = {
